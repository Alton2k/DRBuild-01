...
export interface ApiDealCategoryDealCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'deal_categories';
  info: {
    displayName: 'Deal Category';
    pluralName: 'deal-categories';
    singularName: 'deal-category';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::deal-category.deal-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiDealReportDealReport extends Struct.CollectionTypeSchema {
  collectionName: 'deal_reports';
  info: {
    displayName: 'Deal Report';
    pluralName: 'deal-reports';
    singularName: 'deal-report';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewerId: Schema.Attribute.String & Schema.Attribute.Required;
  };
}

export interface ApiDealVoteDealVote extends Struct.CollectionTypeSchema {
  collectionName: 'deal_votes';
  info: {
    displayName: 'Deal Vote';
    pluralName: 'deal-votes';
    singularName: 'deal-vote';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDealDeal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::deal.deal'> &
      Schema.Attribute.Private;
    moderationReason: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::deal-category.deal-category': ApiDealCategoryDealCategory;
